...
var level_info = {
	"Intro" = {
		...
		[5.2, 6.2, 6.7, 7.5, 8.3, 8.9, 9.5, 10.1, 10.9, 11.5, 12, 12.6, 13.4, 14, 14.5, 15, 15.8, 16.4, 17, 18.1, 18.7, 19.3, 20.4, 21, 21.6, 22.7, 23.3, 23.9, 25.6, 26.2, 26.9, 27.7, 28.3, 28.8, 29.3, 30, 30.6, 31.2, 31.7, 32.4, 33, 33.6, 38.7], 
